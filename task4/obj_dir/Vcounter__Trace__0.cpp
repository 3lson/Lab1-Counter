...
void Vcounter___024root__trace_chg_0_sub_0(Vcounter___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+4,(vlSelfRef.bcd),12);
    bufp->chgCData(oldp+5,(vlSelfRef.top__DOT__count),8);
    bufp->chgIData(oldp+6,(vlSelfRef.top__DOT__myDecoder__DOT__result),20);
}
